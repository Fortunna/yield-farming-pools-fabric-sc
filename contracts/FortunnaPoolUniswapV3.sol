...
contract FortunnaPoolUniswapV3 is IERC721Receiver {
        ...
        )
    {
        ...
        TransferHelper.safeTransferFrom(PTT, msg.sender, address(this), amount0ToMint);
        TransferHelper.safeTransferFrom(USDC, msg.sender, address(this), amount1ToMint);

        // Approve the position manager
        TransferHelper.safeApprove(PTT, address(nonfungiblePositionManager), amount0ToMint);
        ...
        if (amount0 < amount0ToMint) {
            TransferHelper.safeApprove(PTT, address(nonfungiblePositionManager), 0);
            uint256 refund0 = amount0ToMint - amount0;
            TransferHelper.safeTransfer(PTT, msg.sender, refund0);
        }
